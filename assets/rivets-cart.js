...
(function() {
  ...
  Rivets["public"].binders.show = function(el, value) {
    return el.style.display = value ? 'block' : '';
  };
...
(function() {
  ...
  CartJS.Data = {
    ...
    submit: function(e) {
      ...
      let quantityI = document.querySelector(".actualQTY").textContent;
      ...
      jQuery.each(dataArray, function(i, item) {
        ...
        if(item.name === "properties[Interval Frequency]"){
          countFreq = 1;
        }
        if (item.name === 'id') {
      ...
      if(countFreq == 1 && quantityI > 2){
        quantityI = 2;
      }
      return CartJS.Core.addItem(id, quantityI, CartJS.Utils.unwrapKeys(properties));
    },
